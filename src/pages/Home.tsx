      ...
      <div className="hero flex justify-around items-center">
        <div className="hidden sm:flex">
          <div className="info flex flex-col gap-4 w-1/2 ">
            <div className="title ">
              <h1 className="text-6xl font-bold">Visit The Most<span className="text-[#1E429F]"> Beautiful Places</span> In The World</h1>
      ...
      <div className="section mt-4 mb-4">
        ...
        <section className="mt-8 px-4 lg:px-0">
          <div className="flex justify-between items-center mb-4">
            ...
            <button className="text-[#4169E1] font-semibold text-sm">View all</button>
          </div>
        ...
        <section className="mt-10 px-4 mb-20 lg-mb-12">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-bold text-[#111827]">Available Tours</h2>
            <button className="text-[#4169E1] font-semibold text-sm">View all</button>
          </div>
              ...
              <div key={tour.id} className="bg-white p-3 rounded-[24px] shadow-sm border border-gray-50 flex gap-4 items-center hover:shadow-md transition-shadow cursor-pointer">
                ...
                <div className="flex-1 flex flex-col justify-between h-full py-1">
                  <div>
                    ...
                    <h3 className="text-lg md:text-xl font-bold text-[#111827] mt-1">{tour.title}</h3>
                  </div>
                  <p className="text-sm text-gray-500 mt-2">
                    From <span className="text-[#4169E1] font-extrabold text-lg">${tour.price}</span> Per Person
                  </p>
                </div>
              </div>
            ))}
