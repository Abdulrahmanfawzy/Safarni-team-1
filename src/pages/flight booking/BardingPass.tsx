...
const BardingPass = () => {
  ...
  return (
    <>
      <section className="md:pl-25 md:pr-10">
        <Back />
        <div className="max-w-screen  grid md:grid-cols-2 gap-x-2  pb-30">
          <div className=" h-full max-md:hidden ">
            <div className="w-152 h-183.5 pr-25">
              <ImageCard img={flight} />
            </div>
          </div>
          <div className=" h-full max-md:px-5 md:px-14 overflow-hidden">
            <div className="space-y-4 w-full h-full flex flex-col justify-center items-center">
              ...
              <div className="w-full h-full flex flex-col justify-center shadow-lg rounded-2xl p-2 items-center gap-y-6 relative">
                ...
                <div className="w-[120%] max-md:w-[110%] h-3 rounded-2xl absolute -top-2  shadow-[inset_0_8px_8px_0_#4A5F8B] bg-transparent "></div>
